...
/**
 * This class is property of Zowpy © 2021
 *
 * @author Zowpy
 * Created: 1/1/2022
 *
...
public class InventoryUtil {
    ...
    @SneakyThrows
    public void changeTitle(Chest chest, String title) {
        Object titleEntity = chest.getClass().getMethod("getTileEntity").invoke(chest);
        Method changeTitle = titleEntity.getClass().getMethod("a", String.class);
        changeTitle.invoke(titleEntity, C.color(title));
    }
