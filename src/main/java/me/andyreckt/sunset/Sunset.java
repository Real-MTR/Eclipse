...
public class Sunset {
    ...
    private final HashMap<Class<?>, PType<?>> typesMap = new HashMap<>();
    ...
    public Sunset(JavaPlugin plugin) {
        ...
        this.permissionMessage = C.color("&cYou do not have the permission for this command.");
        this.consoleOnlyMessage = C.color("&cThis command is performable only by the console.");
        this.playersOnlyMessage = C.color("&cThis command is performable only by the players.");
        this.invalidSubCommandMessage = C.color("&cYou have entered an invalid subcommand.");
    }
