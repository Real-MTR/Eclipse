    ...
    public boolean execute(CommandSender commandSender, String s, String[] strings) {
        ...
        if (strings[0].equals(command.helpCommand()) && command.autoHelp()) {
            if (!(commandSender instanceof Player)) {
                commandSender.sendMessage(sunset.getPlayersOnlyMessage());
                return false;
            }
        ...
        if (method == null) {
            commandSender.sendMessage(sunset.getInvalidSubCommandMessage());
            return false;
        }
        ...
        if (method.getParameterTypes()[0].equals(ConsoleCommandSender.class)) {
            if (!(commandSender instanceof ConsoleCommandSender)) {
                commandSender.sendMessage(sunset.getConsoleOnlyMessage());
                return false;
            }
        }
